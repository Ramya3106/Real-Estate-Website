  ...
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        ...
        justify-between items-center'>
           ...
           <a href="#" className='font-bold text-3xl sm:text-3xl text-white
          flex gap-2 items-center justify-center'>
            <img src={logo} alt='' className='w-20 aspect-square object-cover rounded-full  border-2 border-white shadow-md' />
            Estate
          </a>
            <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt harum qui corporis quas culpa repellat aliquid adipisci porro temporibus nobis.</p>
            </div> 
           <div className='w-full md:w-1/5 mb-8 md:mb-0'>
            <h3 className='text-white text-lg font-bold mb-14'>Company</h3>
           ...
           <div className='w-full md:w-1/3'>
            ...
            <p className='text-gray-400 mb-4 max-w-80'>The latest news,
              articles, andvresources, sent to your inbox weekly.
            </p>
